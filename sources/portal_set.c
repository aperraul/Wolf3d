...
/*   Updated: 2016/05/18 15:32:09 by aperraul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_set_blue_portal(t_w3d *w3d, t_pt *m)
{
	...
	w3d->portal.orib = ft_wall_side(w3d->ray.map, w3d->cam.pos, w3d->ray.side);
...
void	ft_set_orange_portal(t_w3d *w3d, t_pt *m)
{
	...
	w3d->portal.orio = ft_wall_side(w3d->ray.map, w3d->cam.pos, w3d->ray.side);
